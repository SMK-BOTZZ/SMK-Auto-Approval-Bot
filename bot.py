...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @SMK_NETWORK __**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 SMK_NETWORK", url="https://t.me/SMK_NETWORK"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/SMK_THE_BOTZ")
                    ],[
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/SMK_THE_BOTZ?startgroup")
                    ]
                ]
            )
            ...
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/SMK_THE_BOTZ?startgroup")
                    ]
                ]
            )
            add_group(m.chat.id)
    ...
    try:
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 SMK NETWORK", url="https://t.me/SMK_NETWORK"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/SMK_THE_BOTZ")
                    ],[
